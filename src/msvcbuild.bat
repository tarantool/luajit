...
@set ALL_LIB=lib_base.c lib_math.c lib_bit.c lib_string.c lib_table.c lib_io.c lib_os.c lib_package.c lib_debug.c lib_jit.c lib_ffi.c lib_misc.c
...
>>>>>>> c6c6e3b4 (Update MSVC build script and docs.)
:NODEBUG
